<Query Kind="Program">
  ...
  <NuGetReference>System.Threading.Tasks</NuGetReference>
...
{
	var names = new string[] { "德玛西亚", "李四", "王五", "水电费", "大哥发的", "电饭锅", "第三方", "v我饿v我", "支持支持", "asda", "萨达", "xcvx", "是不额外", 
		"胜多负少", "rnrt", "当前温度","啊实打实","发胜多负少","发的发过的","发光飞碟","部分","" };
	var index = 1;
	...
	//ToCreateQueue(index + 345435, "德玛西亚");
	//ToCreateQueue(index + 12, "李四");
}
...
public async Task ToCreateQueue(int index, string name)
{
	...
	{
		Cdkey = "4DAE0CB9-D62A-4D64-98F0-CA361C546B34",
		CardNo = "123",
		CardType = "1",
